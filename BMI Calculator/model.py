...
st.text("A high BMI can indicate high body fatness. BMI screens for weight categories that may lead to health problems")
st.text("but it does not diagnose the body fatness or health of an individual.")
